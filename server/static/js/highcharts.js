...
(function() {
                        ...
                        if (e !== " ") {
                            ...
                            if (l)
                                ...
                                "$1- ").split(" "), n = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", q, E, s = k.HcHeight, u = [], t = Y(o), Kb = 1; n && (e.length || u.length);)
                                    delete a.bBox, q = a.getBBox(), E = q.width, !ba && c.forExport && (E = c.measureSpanWidth(o.firstChild.data, a.styles)), q = E > l, !q || e.length === 1 ? (e = u, u = [], e.length && (Kb++, s && Kb * t > s ? (e = ["..."], a.attr("title", a.textStr)) : (o = x.createElementNS(xa, "tspan"), F(o, {
                                        dy: t,
                                        x: j
    ...
    Sa.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && I)
                u === "inside" && (I =- I), d.opposite && (I =- I), h = this.getMarkPath(x, w, I, m * y, g, f), n ? n.animate({
                    d: h,
                    opacity: c
    ...
    ma.prototype = {
        ...
        render: function() {
            ...
            if (I)
                b = a.getLinePath(I), a.axisLine ? a.axisLine.animate({
                    d: b
    ...
    Xa.prototype = {
        ...
        propFromSeries: function() {
            ...
            "angular", "polar"], function(g) {
                ...
                for (e = d && d.length; !f && e--;)(c = J[d[e].type]) 
                    && c.prototype[g] && (f=!0);
                a[g] = f
            })
        },
                        ...
                        if (Ba(R) === 0 || this.verifyDataLabelOverflow(R))
                            this.placeDataLabels(), s && g && q(this.points, function(b) {
                                ...
                                if ((t = b.dataLabel) && t._pos)
                                    K = t._attr.visibility, B = t.connX, A = t.connY, k = l ? ["M", B + (x[6] === "left" ? 5 : - 5), A, "C", B, A, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", B + (x[6] === "left" ? 5 : - 5), A, "L", x[2], x[3], "L", x[4], x[5]], j ? (j.animate({
                                        d: k
                                            ...
                                            if (a.graphic)
                                                ...
                                                if (!a._hasTracking)
                                                    ...
                                                    drawTrackerGraph: function() {
                                                        ...
                                                        f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, l = k && {
                                                            cursor: k
